        ...
        <div className='w-[20%] bg-[#ececec] text-[#191970] font-semibold flex py-20 px-7 text-xl h-[96vh] rounded-r-2xl absolute my-5 shadow-lg shadow-white'>
            <div className='w-full'>
                <ul className='gap-10 text-2xl w-full pt-[2em] h-full '>
                    <li className='mt-2 bg-[#191970] text-white px-2 rounded-full text-center py-2'><Link>Home</Link></li>
                    ...
                    <li className='mt-2 bg-[#191970] text-white px-2 rounded-full text-center py-2'><Link>About us</Link></li>
