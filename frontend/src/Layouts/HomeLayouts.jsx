    ...
    return (
        <div className="min-h-screen flex">
            <div>
                ...
                <div className={`w-9/12 hidden md:flex md:w-[20%] bg-white text-[#191970] font-semibold py-20 px-7 text-xl h-[98vh] rounded-r-lg absolute md:my-2 shadow-lg shadow-white drawer`} >
                    ...
                    <div className=''>
                        ...
                        <ul className='gap-10 text-lg md:text-xl w-1/2 md:w-full pt-[2em] h-full mx-2 ' >
                            ...
                            {isUserLoggedIn && (userRole === '"ADMIN"') && (
                                <Link to={"/course/create"}><li className='mt-2 bg-[#191970] text-white px-2 rounded-lg text-center py-2'>Create course</li></Link>
                            )}
                        </ul>
