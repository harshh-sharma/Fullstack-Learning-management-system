            ...
            <div className='bg-[#2a0845] flex justify-center items-center text-white w-full'>
                <div className='bg-white shadow-md shadow-[#FFD700] w-auto h-auto flex justify-center items-center flex-col rounded-md p-4'>
                    ...
                    <div className='mt-2 w-full flex justify-center items-center gap-2'>
                        <div className='w-[50%]'>
                            <Link to={"/profile/edit"}><button className='bg-[#2a0845] font-semibold text-lg py-1 text-[#FFD700]  border-2 border-[#2a0845] w-full rounded-md hover:bg-transparent hover:text-[#2a0845] hover:border-2 hover:border-[#2a0845] transition-all duration-500 ease-in shadow-lg shadow-gray-400'>Edit Profile</button></Link>
                        </div>
                        <div className='w-[50%]'>
                            <Link to={"/user/change-password"}><button className='bg-[#2a0845] font-semibold text-lg py-1 text-[#FFD700]  border-2 border-[#2a0845] w-full rounded-md shadow-lg shadow-gray-400 hover:bg-transparent hover:text-[#2a0845] hover:border-2 hover:border-[#2a0845] transition-all duration-500 ease-in'>Change Password</button></Link>
                        </div>
                    </div>
                </div>
            </div>
