            ...
            <HomeLayouts>
                <div className='pt-10 text-black flex justify-center items-center gap-10 min-h-screen bg-[#191970] w-full'>
                    <div className='w-1/2 space-y-6 text-2xl'>
                        <h1 className='text-white font-semibold text-4xl'>Find out best <span className='text-[#FF6F61] rounded-lg  px-2'>Online courses</span></h1>
                        <p className='text-white'>We have a large library of courses taught by very highly skilled and qualified faculties at very affordable course</p>
