...
const AboutPage = () => {
    return (
        <HomeLayouts>
            <div className='flex flex-col md:flex-row items-center justify-around px-5 bg-[#001F3F] w-full h-auto pt-[5em] md:pt-0'>
                <div className='w-full md:w-[40%] text-[#F5FCDC]'>
